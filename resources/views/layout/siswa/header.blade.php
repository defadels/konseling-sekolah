                        ...
                        <ul class="dropdown-user list-style-none">
                            <li>
                                <div class="dw-user-box p-3 d-flex">
                                    <div class="u-img"><img src="{{asset('materialpro/assets/images/users/avatar.webp')}}" alt="user" class="profile-pic rounded-circle" width="50"></div>
                                    <div class="u-text ml-2">
                                        <h4 class="mb-0">{{Auth::user()->nama}}</h4>
                                        <p class="text-muted mb-1 font-14">{{Auth::user()->email}}</p>
                                        <span class="btn btn-rounded btn-danger btn-sm text-white d-inline-block">{{trans(ucfirst(Auth::user()->jenis))}}</span>
                                    </div>
                                </div>
                            </li>
