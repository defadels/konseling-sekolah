...
class SiswaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('master.siswa.index',compact('daftar_siswa'));
    }
    ...
    public function create()
    {
       ...
       $daftar_agama =[
        ...
        return view('master.siswa.form',compact('url','button','jenis_kelamin','daftar_agama','daftar_kelas'));
    }
    ...
    public function edit(User $siswa)
    {
       ...
       $daftar_agama =[
        ...
        return view('master.siswa.form',compact('url',
